...
//Firmware debugging
#define m2_raw_data_offset_2		(0xA8C)
#define m2_delta_data_offset 		(0xD95)
#define m2_label_data_offset		(0xE83)
#define m2_baseline_E_data_offset 	(0xC0F)
#define m2_baseline_O_data_offset 	(0xCD2)
#define debug_data_offset			(0xBCF)
