...
int lge_mdss_dsi_panel_power_dsv_ctrl(struct mdss_dsi_ctrl_pdata *ctrl_pdata, int enable)
{
	...
	if(enable) {
		rc += dw8768_register_set(DW8768_ENABLE_REG, 0x0F);
		rc += dw8768_register_set(DW8768_DISCHARGE_STATUS_CONTROL_REG, 0x83);
		rc += dw8768_register_set(DW8768_KNOCK_ON_CONTROL_REG, 0x00);
	} else {
		rc += dw8768_register_set(DW8768_ENABLE_REG, 0x07);
		rc += dw8768_register_set(DW8768_DISCHARGE_STATUS_CONTROL_REG, 0x80);
		rc += dw8768_register_set(DW8768_KNOCK_ON_CONTROL_REG, 0x08);
	}
